...
namespace PixelCrushers.DialogueSystem.MenuSystem
{
    ...
    public class SaveHelper : MonoBehaviour
    {
        ...
        [Tooltip("Reset in-memory saved game data when returning to title menu.")]
        public bool resetGameOnReturnToTitle = true;
        ...
        public System.Action returningToTitleMenu = null;
        ...
        {
            returningToTitleMenu?.Invoke();
            DialogueManager.StopAllConversations();
            SaveSystem.BeforeSceneChange();
            if (resetGameOnReturnToTitle) SaveSystem.ResetGameState();
